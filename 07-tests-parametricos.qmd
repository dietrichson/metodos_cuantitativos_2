...
Si aplicamos la fórmula de la [definición @def-t-test] nos sale un valor que podemos comparar con los valores críticos de la tabla del [apendice A](@sec-distribucion-t-table) para determinar si rechazamos $H_0$ o no.
