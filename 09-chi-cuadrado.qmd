...
En particular vamos a explorar la distribuciónd de $\chi^2$ de Pearson. $\chi$ es una letra griega que suele pronunciarse «ji» (/xi/) y «chi» (/tʃiː)/[^09-chi-cuadrado-1].
...
#| label: tab-opiniones-aborto-iii
#| echo: false
myTest <- chisq.test(M)
M3 <- myTest$expected 
...
```{r}
#| label: tab-opiniones-aborto-iiii
#| echo: false
