...
Vamos a desarrollar el tema de la distribución normal con más detalle en el [capítulo
@sec-la-distribucion-normal]. Por ahora simplemente vamos a considerar si los datos de nuestras muestras se asemejan a ésta o si tiene otro perfil.
