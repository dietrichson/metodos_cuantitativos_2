...
```{r}
#| include: false
# This is not actually used as code, since it is not rendered correctly as PDF. 
# It has been rendered online at https://dreampuf.github.io/GraphvizOnline/
# saved as a svg and re-rendered.
library(DiagrammeR)
cual_usar <- '
...
1[label="Muestras independientes"]; 2[label="Datos de intervalo o razón"];
...
#| fig-width: 5
#| fig-height: 8
knitr::include_graphics("images/flowchart-non-parametric.png")
```
