...
Se pueden consultar los valores críticos de la distribución t para distintos grados de libertad en tablas estadísticas, como el del [apendix @sec-distribuciion-t] o en linea. También se puede sacar con una función en R llamada `qt`.
