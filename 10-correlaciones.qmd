...
En la [figura @fig-strong-negative-correlation] vemos lo contrario, mientras avanzamos en el eje vertical retrocedemos (o bajamos) en el eje horizontal. Esto se conoce como *correlacion negativa*.
...
Ahora podemos normalizar las variables según la [definición @def-definition-z-score] asi:
