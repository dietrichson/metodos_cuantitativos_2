...
## Hipotesis nula y una alternativa
...
$H_1$ se leería: «la media de A es desigual a la media de B». Este ejemplo [-@exm-non-directional-hypothesis] es de una predición *no direcional*. Es decir que no hemos tomado una posición a priori sobre si esperamos que las diferencias que observemos sean positivos o negativos.
...
::: {#exm-directional-two}
## Hipotesis nula y una alternativa direccional
...
La diferencia entre usar un test direccional o no direccional influye en los valores críticos de los diferentes tests. Si usamos un test direccional --y está justificado su uso, claro-- disminuye el riesgo de cometer un error de tipo II. Está ilustrado en las figuras [-@fig-non-directional-and-directional-normal-curves-i] y [-@fig-non-directional-and-directional-normal-curves-ii]: para un test no-direcional necesitamos un 2,5% *en cada extremo* de la curva para que sume 5%, en el test direccional «gastamos» todo el lado positivo.

```{r}
#| label: fig-non-directional-and-directional-normal-curves-i
#| echo: false 
#| warning: false 
#| message: false
#| fig-cap: "Test no direccionales y test direccionales" 
...
```{r}
#| label: fig-non-directional-and-directional-normal-curves-ii
#| echo: false 
#| warning: false 
#| message: false
#| fig-cap: "Test no direccionales y test direccionales" 
