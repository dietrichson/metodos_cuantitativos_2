...
```{definition, name='Desviación estándar de la población'}
$$
...
```{definition, label="definition-standard-deviation" ,name='Desviación estándar de la muestra'}
$$
...
> #### ¿Por qué llevamos todo al cuadrado? {.unnumbered}
>
...
```{r boxplot-example, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Ejemplo de box-plot"}
library(ggthemes)
