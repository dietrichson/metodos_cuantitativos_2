...
```{example, label="non-directional-hypotheses", name="Hipotesis nula y una alternativa" }
...
```{example, label="directional-two", name="Hipotesis nula y una alternativa direccional" }
...
```{r non-directional-and-directional-normal-curves, echo=FALSE, warning=FALSE, message=FALSE,fig.cap="Test no direccionales y test direccionales"}
library(bayestestR)
library(tidyverse)
